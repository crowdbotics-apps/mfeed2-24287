"""mfeed2_24287 URL Configuration
...
admin.site.site_header = "mfeed2"
admin.site.site_title = "mfeed2 Admin Portal"
admin.site.index_title = "mfeed2 Admin"

# swagger
api_info = openapi.Info(
    title="mfeed2 API",
    default_version="v1",
    description="API documentation for mfeed2 App",
)
